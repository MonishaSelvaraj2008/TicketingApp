...
namespace Assignment.Core.Handlers.Queries
{
    ...
    public class GetUserStoryHistoryByUserStoryIdQueryHandler : IRequestHandler<GetUserStoryHistoryByUserStoryIdQuery, IEnumerable<UserStoryHistoryDTO>>
    {
        ...
        {
            var userStoryHistory = await Task.FromResult(_repository.UserStoryHistory.GetAll().Where(obj => obj.UserStoryId == request.UserStoryId));
            ...
            return _mapper.Map<List<UserStoryHistoryDTO>>(userStoryHistory);
        }
    }
}